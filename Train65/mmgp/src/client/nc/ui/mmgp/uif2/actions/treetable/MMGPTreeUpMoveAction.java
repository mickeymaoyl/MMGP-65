...
public class MMGPTreeUpMoveAction extends MMGPTreeBaseMoveAction {
	...
	public MMGPTreeUpMoveAction() {
		this.setBtnName(nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("mmgp001_0","0mmgp001-0019")/*@res "向上"*/);
		this.setCode("UpMove");
		this.putValue(Action.SHORT_DESCRIPTION, nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("mmgp001_0","0mmgp001-0019")/*@res "向上"*/);
		this.putValue(
				Action.SMALL_ICON,
				ImageIconLoader
